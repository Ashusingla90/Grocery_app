...
fun BottomNav(
    ...
    val showBottomBar = isVisible && currentRoute != Screens.PhoneAuthScreen.route
    ...
    val bottomNavItems = listOf(
        ...
        BottomNavItem(
            ...
            screen = Screens.FinalCheckOutScreen
        ),
        BottomNavItem(
            title = "Profile",
        ...
        floatingActionButton = {
            ...
            if (showCartButton && itemCount > 0) {
                ...
                FloatingCartButton(
                    itemCount = itemCount,
                    onClick = {
                        navController.navigate(Screens.FinalCheckOutScreen.route)
                    }
                )
            }
        }
